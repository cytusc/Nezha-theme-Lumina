...
export function FloatingControls() {
  ...
  return (
    <div className="fixed right-3 top-7 z-40 flex justify-end sm:right-5 md:right-6 lg:right-8 lg:top-8">
      <div className="flex flex-col items-end gap-3">
        <div className="control-group is-vertical" role="group" aria-label="设置">
          ...
          <a
            ...
            title={adminLabel}
            className="control-button control-toggle grid h-9 w-9 place-items-center"
          >
            <Settings size={18} />
          </a>
        </div>
